...
export function ThemeSelector(props) {
  ...
  return (
    <Listbox as="div" value={theme} onChange={setTheme} {...props}>
      ...
      <ListboxButton
        className="flex h-8 w-8 items-center justify-center rounded-lg shadow-md ring-1 shadow-black/5 ring-black/5 dark:bg-slate-700 dark:ring-white/5 dark:ring-inset"
        aria-label="Theme"
      >
        <LightIcon
          className={clsx(

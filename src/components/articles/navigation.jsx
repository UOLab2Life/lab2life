                  ...
                  <Link
                    ...
                    className={clsx(
                      ...
                      link.href === pathname
                        ...
                        : 'font-inter-semibold text-slate-500/70 before:hidden before:bg-slate-300 hover:bg-gradient-to-r hover:from-indigo-300 hover:via-violet-400 hover:to-indigo-300 hover:bg-clip-text hover:text-transparent hover:before:block dark:text-slate-300/90 dark:before:bg-white dark:hover:text-slate-300',
                    )}
                  >
                    {link.title}
                  </Link>

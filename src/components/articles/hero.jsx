...
export function Hero() {
  ...
  return (
    <div className="dark:-mt-19 dark:pt-19 overflow-hidden bg-[#003e3e] dark:-mb-32 dark:pb-32 w-full">
      <div className="py-16 sm:px-2 lg:relative lg:px-0 lg:py-20 w-full">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-full lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">

...
function SitemapLink(props) {
  return (
    <li>
      <a
        {...props}
        className="inline-block transform-gpu bg-gradient-to-r from-indigo-300 via-violet-400 to-indigo-300 bg-clip-text font-semibold text-transparent transition-transform duration-500 ease-out will-change-transform before:block before:content-[''] hover:scale-105 hover:opacity-80"
      />
    </li>
  )
}

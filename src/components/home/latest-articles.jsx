        ...
        <div className="mx-auto max-w-2xl lg:max-w-7xl">
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="relative flex flex-col overflow-hidden rounded-3xl bg-white shadow-lg shadow-[#003e3e]/60 ring-1 ring-black/5">
              <img
                alt={locale === 'fr' ? 'Thérapeute sportif au travail' : 'Athletic therapist at work'}
                className="aspect-3/2 w-full object-cover"
                src="https://brocku.ca/brock-news/wp-content/uploads/2020/09/KelseyMarshall-1600x1067.jpg?x56978"
              />
              <div className="flex flex-1 flex-col p-8">
                <div className="flex items-center gap-2 text-sm/5 text-gray-700">
                  ...
                  {locale === 'fr' ? `Le ${formatEventDate('2026-02-16', null, 'fr')}` : 'February 16th, 2026'}
                </div>
                <div className="mt-2 text-lg/7 font-medium">
                  <a
                    href={getLocalizedUrl('/articles/work-athletic-therapists', locale)}
                    className="text-[#003e3e] transition-colors hover:text-[#003e3e]/80"
                  >
                    <span className="absolute inset-0"></span>
                    {locale === 'fr'
                      ? 'De la blessure à la guérison - le travail des thérapeutes sportifs'
                      : 'From Injury to Recovery - The Work of Athletic Therapists'}
                  </a>
                </div>
                <div className="mt-2 flex-1 text-sm/6 text-gray-500">
                  {locale === 'fr'
                    ? "Dans les dernières minutes d'un match serré, un athlète s'effondre et un thérapeute sportif intervient immédiatement. Cet article explore leur rôle clé entre blessure et guérison complète, de l'urgence sur le terrain à la réadaptation structurée..."
                    : 'In the final minutes of a close game, an athlete goes down and an athletic therapist responds immediately. This article explores their critical role between injury and full recovery, from emergency care to structured rehabilitation...'}
                </div>

          ...
          <div className="mx-auto max-w-2xl lg:max-w-7xl">
            ...
            <div className="mt-12 text-center">
              <a
                ...
                className="font-inter-semibold inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-3 text-white shadow-lg transition-all duration-300 hover:from-purple-600 hover:to-pink-600 hover:shadow-xl"
              >

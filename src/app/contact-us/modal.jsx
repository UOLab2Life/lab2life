    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-8 mx-4 max-w-md w-full">
        <div className="text-center">
          ...
          <button
            onClick={onClose}
            className="w-32 bg-red-500 hover:bg-white hover:border hover:border-red-500 hover:text-red-500 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 shadow-md"
          >
            Close
          </button>
        </div>
